		...
		<div class="container">
			<div style="flex-wrap: unset !important;" class="row">
				...
				<div class="cart icon">
					...
					<a style="font-size: 18px; color:white" href="{{ asset('cart/show') }}">{{ Cart::getContent()->count() }}</a>
        		</div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="hotline" class="col-md-3 col-sm-12 col-xs-12">
                            <h3>Hotline</h3>
                            <p>Phone1: (+84) 362384613</p>
                            <p>Phone2: (+84) 382149204</p>
                            <p>Email: haivanghia@gmail.com</p>
                        </div>
                        <div id="contact" class="col-md-3 col-sm-12 col-xs-12">
                            <h3>Contact Us</h3>
                            <p>Address : Đại Học Công Nghệ Sài Gòn- TPHCM</p>
                        </div>
                    </div>
                </div>
            </div>
